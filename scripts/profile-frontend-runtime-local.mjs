...
const TARGET_URL = process.env.BENCH_URL || 'http://localhost:3001';
...
async function setupRuntimeMonitor(page) {
  await page.evaluate(() => {
    ...
    window.__stopRecording = () => {
      ...
      const severeJankFrames = frames.filter(f => f > 50).length;
...
async function main() {
  console.log(`================================================================`);
  console.log(`[OPTIMIZED FRONTEND RUNTIME AUDIT] Target: ${TARGET_URL}`);
  console.log(`================================================================\n`);
  ...
  console.log(`\n================================================================`);
  console.log(`[OPTIMIZED FRONTEND RUNTIME AUDIT COMPLETED]`);
  console.log(`================================================================`);
}
